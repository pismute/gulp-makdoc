...
_makdoc.model.loadDirectoryModel = function() {
    return through.obj(function(file, enc, done){
        if (file.isNull()) {
            return done(null, file);
        }
...
_makdoc.model.finalize = function() {
    return through.obj(function(file, enc, done){
        if (file.isNull()) {
            return done(null, file);
        }
...
_makdoc.util.highlight_highlightjs = function (){
...
_makdoc.util.highlight_pygment = function (){
...
_makdoc.util.highlight_nothing = function (){
    return function(code, lang, done){
        done(null, code);
    };
};

_makdoc.util.highlight = _makdoc.util.highlight_highlightjs
